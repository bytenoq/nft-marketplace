...
export default function List() {
  ...
  const [soldNFTs, setSoldNFTs] = useState(['not-loaded'])
  const [unsoldNFTs, setUnsoldNFTs] = useState(['not-loaded'])
  ...
  if (loading === 'loaded' && !soldNFTs.length && !unsoldNFTs.length) return (
  ...
  return (
    <section class="pt-2 pb-2">
      ...
      <div class="container">
        <div class="row pt-5">
          <div class="col-12">
            <h3 class="border-bottom mb-4">Cancel listing of an NFT</h3>
          </div>
        </div>
        <div class="row">
        {
          unsoldNFTs.map((nft, i) => (
            <div class="col-lg-4 mb-3 d-flex">
              <div class="card">
                <div class="card-header bg-light">
                  <div key={i}>
                ...
                <div class="card-body d-flex flex-column bg-light rounded">
                  ...
                  <p class="card-text">{nft.description}</p>
                  <div>
                    <button className="mt-auto btn input-block-level form-control btn-danger" onClick={() => cancelListing(nft)}>Cancel Listing</button>
                  </div>
                </div>
              </div>
            </div>
